...
public class Main {
    ...
    public static void agregarEquipos(ArrayList<Equipo> listaDeEquipos) {
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Asegurese de:\n\n" +
                            "* Haber cargado correctamente los datos.\n" +
                            "* Haber cargado las opciones anteriores en el menú.",
    ...
    public static void resultadoDelTorneo(Jugador jugador) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Has conseguido " + jugador.getPuntaje()
                            + " por elegir al equipo: " + jugador.getEquipoSeleccionado().getNombre(),
    ...
    //2. Opcion de cargar manualmente
